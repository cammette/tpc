 ...
 *
 */
public interface TaskParallelClientInterface {
	/**
	 * 同步执行任务并等待任务执行结果
	 * @param tasks
	 * @param excuteTimeout
	 * @return
	 */
	public TaskResult excuteSync(List<Object> tasks,String batchNo,long excuteTimeout,Map<String, String> messageProperties)  throws TaskExcutedReplyTimeoutException ;
